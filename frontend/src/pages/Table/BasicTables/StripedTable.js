...
const API_HOST = "http://35.238.161.243:5000/topupvotereddits/covid";
function App() {
    ...
    return (
      ...
      <CardContent>
        <Typography color="textSecondary" gutterBottom>
          The Most Growing Topics in Reddit
        </Typography>
        <Divider />
        <Table>
          <TableHead>
            <TableRow>
              <TableCell style={styles.columns.id}>Topic Upvote Ratio</TableCell>
